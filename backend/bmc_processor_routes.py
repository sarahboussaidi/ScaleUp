...
TEXT_CLASSIFIER_PATH = os.path.join(BASE_DIR, "models", "bmc_generation", "text_classifier")
YOLO_WEIGHTS_PATH = os.path.join(BASE_DIR, "models", "bmc_generation", "yolo_s.pt")
SDG_CLASSIFIER_PATH = os.path.join(BASE_DIR, "models", "bmc_generation", "sdg_distilbert")
RAG_INDEX_PATH = os.path.join(BASE_DIR, "Bmc_generation", "rag_index")
EMBEDDING_MODEL_PATH = os.path.join(BASE_DIR, "models", "bmc_generation", "embedding_model")
